...
fn meters_to_absolute(chunk_size: u8, voxel_size: f32) -> f32 {
    let a = math::lorentz_normalize(&(dodeca::Vertex::A.chunk_to_node() * na::Vector4::new(1.0, 0.5, 0.5, 1.0)));
    let b = math::lorentz_normalize(&(dodeca::Vertex::A.chunk_to_node() * na::Vector4::new(0.0, 0.5, 0.5, 1.0)));
