...
pub struct SimConfigRaw {
    ...
    /// Maximum floor slope (0=horizontal, 1=45 degrees)
    pub max_floor_slope: Option<f32>,
...
impl SimConfig {
    pub fn from_raw(x: &SimConfigRaw) -> Self {
        ...
        SimConfig {
            ...
            max_floor_slope: x.max_floor_slope.unwrap_or(1.73), // 60 degrees
            ...
            ground_distance_tolerance: x.ground_distance_tolerance.unwrap_or(0.2) * meters_to_absolute,
