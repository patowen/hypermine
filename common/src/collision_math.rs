...
#[derive(Debug)]
pub struct Ray {
    pub position: MUnitPointVector<f32>,
    pub direction: MUnitDirectionVector<f32>,
}
...
impl Ray {
    ...
    pub fn solve_sphere_line_intersection(
        &self,
        line_normal1: &MUnitDirectionVector<f32>,
        line_normal0: &MUnitDirectionVector<f32>,
        sinh_radius: f32,
    ) -> Option<f32> {
    ...
    pub fn solve_sphere_point_intersection(
        &self,
        point_normal0: &MUnitDirectionVector<f32>,
        point_normal1: &MUnitDirectionVector<f32>,
        point_normal2: &MUnitDirectionVector<f32>,
        sinh_radius: f32,
    ) -> Option<f32> {
...
mod tests {
    ...
    fn solve_sphere_plane_intersection_direct_hit() {
        ...
        let ray = MIsometry::translation_along(&na::Vector3::new(0.0, 0.0, -0.5))
            * &Ray::new(MUnitPointVector::origin(), MUnitDirectionVector::z());
        let normal = -MUnitDirectionVector::z();
        assert_abs_diff_eq!(
            ray.solve_sphere_plane_intersection(&normal, 0.2_f32.sinh())
                .unwrap(),
    ...
    fn solve_sphere_plane_intersection_miss() {
        ...
        let ray = MIsometry::translation_along(&na::Vector3::new(0.0, 0.0, -0.5))
            * &Ray::new(MUnitPointVector::origin(), MUnitDirectionVector::x());
        let normal = -MUnitDirectionVector::z();
        assert!(ray
    ...
    fn solve_sphere_line_intersection_example() {
        ...
        let line_normal0 = MUnitDirectionVector::x();
        let line_normal1 = MUnitDirectionVector::z();
        let hit_point = ray
            .ray_point(
    ...
    fn solve_sphere_line_intersection_precision() {
        ...
        let ray = Ray::new(
            MUnitPointVector::new_unchecked(-0.019093871, -0.0014823675, 0.059645057, 1.0019588),
            MUnitDirectionVector::new_unchecked(-0.02954007, 0.9965602, 0.07752046, 0.003702946),
        );
        let line_normal0 = MUnitDirectionVector::<f32>::x();
        let line_normal1 = MUnitDirectionVector::<f32>::y();
    ...
    fn solve_sphere_point_intersection_example() {
        ...
        let point_position = MUnitPointVector::origin();
        let point_normal0 = MUnitDirectionVector::x();
        let point_normal1 = MUnitDirectionVector::y();
        let point_normal2 = MUnitDirectionVector::z();
        let hit_point = ray
            .ray_point(
